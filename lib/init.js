...
function initConfigFile(){
    ...
    if (fs.existsSync(destFile)){
        console.log(("ERROR: config.json is node exist, please check your file and try again!").red);
        return;
    }
    var config = JSON.parse(fs.readFileSyncfile());
    config.vars.request_acc_switch = request_acc_switch || "off";
    ...
    fs.writeFileSync(destFile, JSON.stringify(config));
}
